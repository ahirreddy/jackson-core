package shaded.com.fasterxml.jackson.core.format;

import java.io.*;

import shaded.com.fasterxml.jackson.core.*;
import shaded.com.fasterxml.jackson.core.format.DataFormatDetector;
import shaded.com.fasterxml.jackson.core.format.DataFormatMatcher;
import shaded.com.fasterxml.jackson.core.format.MatchStrength;

public class TestJsonFormatDetection extends shaded.com.fasterxml.jackson.test.BaseTest
{
